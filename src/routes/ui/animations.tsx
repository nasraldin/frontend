    ...
    <main class="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
        ...
        <div class="mx-auto max-w-6xl">
          ...
          <div class="grid gap-8 md:grid-cols-2">
            <SlideIn
              direction="up"
              trigger="scroll"
              className="rounded-lg bg-gradient-to-r from-pink-500/20 to-rose-500/20 p-8"
            >
              <h3 class="mb-4 text-2xl font-semibold">Scroll Trigger</h3>
              <p class="mb-4 text-gray-300">
                This slides in when scrolled into view
              </p>
              <div class="h-32 w-full rounded-lg bg-gradient-to-r from-pink-500 to-rose-500 opacity-50" />
            </SlideIn>
            ...
            <SlideIn
              ...
              duration={0.8}
              easing="ease-out"
              className="rounded-lg bg-gradient-to-r from-cyan-500/20 to-blue-500/20 p-8"
            >
              <h3 class="mb-4 text-2xl font-semibold">Hover Trigger</h3>
              <p class="mb-4 text-gray-300">
                Hover over this card to see the animation
              </p>
              <div class="h-32 w-full rounded-lg bg-gradient-to-r from-cyan-500 to-blue-500 opacity-50" />
            </SlideIn>
          </div>
        </div>
      </section>
        ...
        <div class="mx-auto max-w-6xl">
          ...
          <div class="grid gap-6 md:grid-cols-4">
            <ScaleIn
              ...
              duration={0.8}
              delay={0.1}
              className="rounded-lg bg-gradient-to-br from-green-500/20 to-emerald-500/20 p-6 text-center"
            >
            ...
            <ScaleIn
              ...
              duration={0.9}
              delay={0.2}
              className="rounded-lg bg-gradient-to-br from-yellow-500/20 to-orange-500/20 p-6 text-center"
            >
            ...
            <ScaleIn
              ...
              duration={1.0}
              delay={0.3}
              className="rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-6 text-center"
            >
            ...
            <ScaleIn
              ...
              duration={0.7}
              delay={0.4}
              className="rounded-lg bg-gradient-to-br from-red-500/20 to-rose-500/20 p-6 text-center"
            >
            ...
            <div class="grid gap-6 md:grid-cols-2">
              <div class="text-center">
                ...
                <ScaleIn
                  ...
                  trigger="scroll"
                  duration={0.8}
                  className="mx-auto inline-block rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 p-8"
                >
              ...
              <div class="text-center">
                ...
                <ScaleIn
                  ...
                  trigger="hover"
                  duration={0.6}
                  className="mx-auto inline-block rounded-lg bg-gradient-to-br from-pink-500/20 to-rose-500/20 p-8"
                >
      ...
      <section id="stagger" class="bg-black/20 px-4 py-20">
        <div class="mx-auto max-w-6xl">
          ...
          >
            <div class="rounded-lg bg-gradient-to-br from-indigo-500/20 to-purple-500/20 p-6">
              <h3 class="mb-2 text-xl font-semibold">Card 1</h3>
              <p class="text-gray-300">First to animate</p>
            </div>
            <div class="rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-6">
              <h3 class="mb-2 text-xl font-semibold">Card 2</h3>
              <p class="text-gray-300">Second to animate</p>
            </div>
            <div class="rounded-lg bg-gradient-to-br from-pink-500/20 to-rose-500/20 p-6">
        ...
        <div class="mx-auto max-w-6xl">
          ...
          <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <ShowOffers
              ...
              intensity="high"
              trigger="scroll"
              className="rounded-lg bg-gradient-to-br from-red-500/20 to-pink-500/20 p-6 text-center"
            >
            ...
            <ShowOffers
              ...
              intensity="high"
              trigger="scroll"
              className="rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 p-6 text-center"
            >
            ...
            <ShowOffers
              ...
              intensity="high"
              trigger="scroll"
              className="rounded-lg bg-gradient-to-br from-purple-500/20 to-violet-500/20 p-6 text-center"
            >
            ...
            <ShowOffers
              ...
              intensity="medium"
              trigger="scroll"
              className="rounded-lg bg-gradient-to-br from-teal-500/20 to-blue-500/20 p-6 text-center"
            >
            ...
            <ShowOffers
              ...
              intensity="high"
              trigger="scroll"
              className="rounded-lg bg-gradient-to-br from-indigo-500/20 to-purple-500/20 p-6 text-center"
            >
          ...
          <div class="mt-16">
            ...
            <div class="flex flex-wrap justify-center gap-6">
              <ShowOffers
                ...
                intensity="medium"
                trigger="always"
                className="rounded-lg bg-gradient-to-r from-red-500/30 to-pink-500/30 px-6 py-3 text-white"
              >
              ...
              <ShowOffers
                ...
                intensity="high"
                trigger="always"
                className="rounded-lg bg-gradient-to-r from-yellow-500/30 to-orange-500/30 px-6 py-3 text-white"
              >
              ...
              <ShowOffers
                ...
                intensity="medium"
                trigger="always"
                className="rounded-lg bg-gradient-to-r from-green-500/30 to-emerald-500/30 px-6 py-3 text-white"
              >
              ...
              <ShowOffers
                ...
                intensity="high"
                trigger="always"
                className="rounded-lg bg-gradient-to-r from-purple-500/30 to-violet-500/30 px-6 py-3 text-white"
              >
              ...
              <ShowOffers
                ...
                intensity="low"
                trigger="always"
                className="rounded-lg bg-gradient-to-r from-blue-500/30 to-cyan-500/30 px-6 py-3 text-white"
              >
        ...
        <div class="mx-auto max-w-4xl text-center">
          ...
          <div class="flex flex-wrap justify-center gap-6">
            <MagneticButton strength="weak" className="inline-block">
              <button class="rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-4 font-semibold text-white transition-shadow hover:shadow-lg">
                Weak Magnetic
              </button>
            </MagneticButton>

            <MagneticButton strength="medium" className="inline-block">
              <button class="rounded-lg bg-gradient-to-r from-green-500 to-teal-600 px-8 py-4 font-semibold text-white transition-shadow hover:shadow-lg">
                Medium Magnetic
              </button>
            </MagneticButton>

            <MagneticButton strength="strong" className="inline-block">
              <button class="rounded-lg bg-gradient-to-r from-red-500 to-pink-600 px-8 py-4 font-semibold text-white transition-shadow hover:shadow-lg">
                Strong Magnetic
              </button>
            </MagneticButton>
          </div>
        ...
        <div class="mx-auto max-w-6xl">
          ...
          <div class="space-y-32">
            <ParallaxScroll
              speed={0.08}
              direction="up"
              className="rounded-lg bg-gradient-to-r from-blue-500/30 to-purple-500/30 p-12 text-center"
            >
            ...
            <ParallaxScroll
              speed={-0.06}
              direction="down"
              className="rounded-lg bg-gradient-to-r from-green-500/30 to-teal-500/30 p-12 text-center"
            >
            ...
            <ParallaxScroll
              speed={0.04}
              direction="left"
              className="rounded-lg bg-gradient-to-r from-yellow-500/30 to-orange-500/30 p-12 text-center"
            >
